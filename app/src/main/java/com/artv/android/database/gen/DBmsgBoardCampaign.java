...
public class DBmsgBoardCampaign {
    ...
    public DBmsgBoardCampaign(Long id, Integer msgBoardId, String crcVersion, String startDate, String endDate, String playDay, String textColor, String RightBkgURL, String BottomBkgURL) {
        this.id = id;
