...
public class DBmsgBoardCampaign {
    ...
    public DBmsgBoardCampaign(Long id, Integer crcVersion, Long startDate, Long endDate, String playDay, String textColor, String RightBkgURL, String BottomBkgURL) {
        this.id = id;
